...
% ops.fbinary             = 'F:\configFiles\example_short'; % will be created for 'openEphys'		
ops.fproc               = 'F:\configFiles\temp_wh.dat'; % residual from RAM of preprocessed data		
% ops.root                = 'F:\testData\CD190819A_2019-09-17_10-29-49_matchingBlocks\'; %'F:\'; %'C:\DATA\Spikes\Piroska'; % 'openEphys' only: where raw files are		
...
ops.chanMap             = 'F:\configFiles\chanMap.mat'; % make this file using createChannelMapFile.m		
